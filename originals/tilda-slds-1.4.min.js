        ...
        if (l) {
          ...
          if (
            ...
            ;(y &&
              ...
              r.getAttribute('data-slider-totalslides') || r.setAttribute('data-slider-totalslides', d))
            var v = 1,
            ...
            ;(b.length &&
              ...
              window.addEventListener('load', function () {
                ;('true' == r.getAttribute('data-slider-correct-height') && t_slds_UpdateSliderHeight(t),
...
function t_slds__removeAutoplayByVideo(t) {
  var e = t.target.closest('.t-slds__item'),
    s = null == e ? void 0 : e.querySelector('[data-slider-video-type], [data-videolazy-type], iframe')
  if (s) {
    var r = s.closest('.t-slds__items-wrapper'),
      i
    if (r)
      r.getAttribute('data-slider-interval-id') &&
        (r.setAttribute('data-slider-stopped', 'yes'), r.setAttribute('data-slider-stopped-by-video', 'y'))
  }
}
...
function t_slds__hideMobileSlides(t) {
  if (t) {
    ...
    if (!s || 'scroll' !== s.overflowX || 'flex' !== s.display) {
      var r = Array.prototype.slice.call(e.querySelectorAll('.t-slds__item:not(.t-slds__item_dummy)')),
        i = document.documentElement.clientWidth > 960 ? 5 : 3
      if (!(r.length <= 2 * i)) {
        for (var a = t.getAttribute('data-slide-index'), l = [(a = parseInt(a, 10))], d = 1; d < i; d++)
          (a + d <= r.length ? l.push(a + d) : l.push(d), a - d > 0 ? l.push(a - d) : l.push(r.length + 1 - d))
  ...
  if (s) {
    ...
    if (r)
      ((r.getAttribute('data-slider-items-in-row') || 0) &&
        (window.innerWidth <= 960 && (a = 2), window.innerWidth <= 640 && (a = 1), window.innerWidth > 960 && (a = e)),
...
function t_slideMoveWithoutAnimation(t, e, s) {
  ...
  if (r) {
    ...
    if (i) {
      ...
      ;(t_slideMove(t, e, s), n && i.classList.remove('t-slds_animated-cancel'), c && r.dispatchEvent(p))
    }
  }
}
function t_slideMoveInstantly(t, e, s) {
  ...
  if (r) {
    ...
    if (i) {
      ...
      ;(t_slideMove(t, e, s), i.classList.remove('t-slds_animated'), i.classList.remove('t-slds_animated-cancel'))
    }
  }
}
      ...
      if (
        ...
        if (y)
          if (l) {
            ...
            'false' == i.getAttribute('data-slider-with-cycle') && (_ == u || (d > 1 && _ == u - d + 1))
        ...
        ;(v &&
          ...
          h >= 13 && A && !f ? t_slide_MoveAnimation(i, _, n, c) : (i.style.transform = 'translateX(-' + n * _ + 'px)'),
  ...
  if (e) {
    ...
    if (s) {
      ...
      ;((s.style.transform = 'translateX(-' + l * d + 'px)'),
        ...
        t_slds_UpdateSliderArrowsHeight(t),
        'y' === s.getAttribute('data-slider-stopped-by-video') && s.setAttribute('data-slider-stopped-by-video', ''))
    }
  }
}
...
function t_slds_ActiveSlide(t, e, s) {
  ...
  if (r) {
    ...
    if (
      ...
      (r.querySelector('.t-slds__item[data-slide-index="' + s + '"]').classList.add('t-slds__item_active'),
...
function t_slds_fixArrowsInCatalog(t, e, s, r) {
  if (
    e &&
    r &&
    (t.classList.contains('t-catalog__relevants-grid-cont') || t.classList.contains('t-store__relevants-grid-cont'))
  ) {
      ...
      if ((c && clearInterval(c), 'true' !== d.getAttribute('data-slider-stop'))) {
          ...
          1 === a.length &&
            window.bind(
              ...
              t_throttle(function () {
                ...
                'none' !== t
                  ? ((f = a.getBoundingClientRect().top + window.pageYOffset),
                    (m = f + a.offsetHeight) > e && f < s && 'y' !== d.getAttribute('data-slider-stopped-by-video')
                      ? d.setAttribute('data-slider-stopped', '')
                      : '' === d.getAttribute('data-slider-stopped') && d.setAttribute('data-slider-stopped', 'yes'))
        ...
        var g = setInterval(function () {
          ...
          'yes' != e &&
            ...
            t_slds_updateSlider(t),
            'yes' == n && (_ == s + 1 && (_ = 1), 0 == _ && (_ = s), d.setAttribute('data-slider-pos', _)),
              ...
              ;(window.removeEventListener('touchmove', m, {passive: !1}),
                ...
                window.hammer.on('pan', function (e) {
                  ...
                  if ((s.setAttribute('data-slider-touch', 'yes'), t_slds_scrollImages(t, d * c - p), e.isFinal)) {
                    if (e.velocityX > 0.4)
                      ('false' == s.getAttribute('data-slider-with-cycle') && 1 == c ? (c = 1) : c--,
                        s.setAttribute('data-slider-pos', c),
                        0 == c && (u = 'yes'),
                        s.setAttribute('data-slider-cycle', u),
                        t_slideMove(t, !1, r))
                    else if (e.velocityX < -0.4) {
                      if ('false' == s.getAttribute('data-slider-with-cycle') && (c == _ || (l && c == _ - a + 1)))
                        c = l ? _ - a : _
                      else {
                        var h = i.querySelectorAll('.t-slds__item:not(.t-slds__item_dummy)'),
                          b = h[h.length - 1],
                          A = parseFloat(b.getAttribute('data-slide-index'), 10)
                        if (A < _ && c == A) {
                      ...
                      f <= -30 / _
                        ? ('false' == s.getAttribute('data-slider-with-cycle') && (c == _ || (l && c == _ - a + 1))
                            ? (c = l ? _ - a : _)
                            : c++,
                          s.setAttribute('data-slider-pos', c),
                          c == _ + 1 && (u = 'yes'),
...
function t_slds_changeImageUrl(t) {
  var e = document.getElementById('allrecords'),
    ...
    i
  r &&
    ((i = s ? r.querySelectorAll('.t-slds__img:not([data-original])') : r.querySelectorAll('.t-slds__img')),
    Array.prototype.forEach.call(i, function (t) {
...
function t_slds_fadeIn(t, e, s) {
  if (
    ...
    var l = setInterval(function () {
      ;((t.style.opacity = r),
        (r += 0.1) >= 1 && (clearInterval(l), t.removeAttribute('data-fadein-timeout'), 'function' == typeof s && s()))
    }, a)
...
function t_slds_getEventsForZeroBlock() {
  ...
  return (
    'function' == typeof window.CustomEvent
      ? ((t = new CustomEvent('tildaSldsMoveSlideStart')), (e = new CustomEvent('tildaSldsMoveSlideEnd')))
      : ((t = document.createEvent('CustomEvent')).initCustomEvent('tildaSldsMoveSlideStart', !0, !0),
...
function applyBaseStyles(t) {
  for (var e = t.querySelectorAll('.js-product'), s = 0; s < e.length; s++)
    for (
      var r, i = e[s].querySelectorAll('.t-catalog__card__textwrapper, .t-store__card__textwrapper'), a = 0;
      a < i.length;
      a++
    ) {
      var l = i[a]
...
function getReferenceHeight() {
  ...
  for (var e = t.querySelectorAll('.js-product'), s = 0; s < e.length; s++) {
    var r = e[s]
    if ('none' !== window.getComputedStyle(r).display && 0 !== r.offsetHeight && r.querySelector('.js-product-img')) {
...
function addEmptyDescrPlaceholder(t) {
  var e = t.querySelector('.js-catalog-prod-descr.t-catalog__card__descr, .js-store-prod-descr.t-store__card__descr')
  if (e) {
    ...
    t.querySelectorAll('.js-product').forEach(function (t) {
      if (
        !t.querySelector('.js-catalog-prod-descr.t-catalog__card__descr, .js-store-prod-descr.t-store__card__descr')
      ) {
