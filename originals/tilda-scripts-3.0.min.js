        ...
        if (document.body.contains(n) && !n.classList.contains('t975') && !n.classList.contains('t975')) {
          ...
          if ('fixed' === r || 'absolute' === r) {
            ...
            ;(!l && 0 !== l) || 'auto' === n.style.right || 'absolute' === r || m
              ? m && !p && (n.style.width = 'calc(100vw - ' + t.scrollBarWidth + 'px)')
  ...
  t &&
    ...
    Array.prototype.forEach.call(t.fixedElements, function (t) {
      ...
      ;(e.hasAttribute('data-tilda-initial-right')
        ? ((e.style.right = e.getAttribute('data-tilda-initial-right')), e.removeAttribute('data-tilda-initial-right'))
...
;((window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2)),
  ...
  t_onReady(function () {
    ...
    var w = document.querySelector('.t-tildalabel'),
      f
    ;(f = h ? Math.max(h.scrollHeight, h.offsetHeight, h.clientHeight, p.offsetHeight) : p.offsetHeight) + 70 <
    window.innerHeight
        ...
        for (
          ...
          if (m > e) {
            if (
              ...
              return
            ;(console.log(
              'Block not optimized for mobile width. Block width:' + m + ' Block id:' + d.getAttribute('id')
            ),
              console.log(u),
