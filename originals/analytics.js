...
*/
  ...
  function K(a, b) {
    ...
    b === 'port'
      ...
      : b === 'host' && (a.hostname = (a.hostname || C.location.hostname).replace(J, '').toLowerCase())
    return M(a, b)
  }
  function M(a, b, c) {
    var d = L(a.protocol)
  ...
  q('google_tag_data.tcBridge.setSideload', function (a, b, c) {
    ...
    c = H().container[b]
    ;(c && c.state !== 3) || ((H().container[b] = {state: 1, context: d, parent: a}), ea({ctid: b, isDestination: !1}))
  })
...
;(function () {
  ...
  function Pa(a) {
    ...
    ue.map(function (c, d) {
      d.F &&
        ((c = a.get(c)),
        c != void 0 && c != d.defaultValue && (typeof c == 'boolean' && (c *= 1), b.push(d.F + '=' + K('' + c))))
    })
      ...
      if (P(a, ac) == 'cookie') {
        ...
        if (a.get(je)) {
          if ((b = P(a, ce))) {
            ...
            g && g != 'aw.ds'
              ? d && (d.ua = !0)
              : ((b = ['1', e, Cc(b)].join('.')), c >= 0 && (d && (d.ta = !0), zc('_gac_' + Cc(k), b, ca, l, k, c, w)))
            le(d)
          }
        } else J(75)
        a.get(je) &&
  ...
  function td(a, b) {
    ...
    if (P(a, ac) == 'cookie') {
      ...
      a.get(je) &&
        ...
        (d = (M ? ob(c) : {})[P(a, Na)]),
        le(c),
        d && d.length != 0 && ((c = d[0]), a.data.set(fe, c.timestamp / 1e3), a.data.set(ce, c.qa)))
      a.get(je) &&
        ((c = a.get(Se)),
        (d = {}),
        ...
        if ((c && e && J(36), a.get(bc) || ye(a.get(Kd)) || g)) {
          if (
            ...
            ca
              ...
              : l && (e = l.split('.')) && e.length === 2 && (J(37), a.data.set(ce, e[0]), a.data.set(fe, e[1])),
    ...
    ae = function (a) {
      ...
      D(a, '//')
        ...
        : D(a, '/')
          ...
          : !a || D(a, '?')
            ? (a = g + d[2] + (a || e))
            : a.split('/')[0].indexOf(':') < 0 && (a = g + d[2].substring(0, d[2].lastIndexOf('/')) + '/' + a)
      b.href = a
      c = kf(b)
      return {
