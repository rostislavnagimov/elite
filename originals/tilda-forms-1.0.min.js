            ...
            return Promise.resolve(Promise.allSettled(o)).then(function (r) {
              ...
              ;(r
                ...
                t_formsApi__isConditionalForm(e) &&
                  t.dispatchEvent(new CustomEvent('sync-conditionals', {detail: {shouldPreventSubmit: !1}})))
            })
          },
          function (t) {
  ...
  if (o) {
    ...
    if (n) {
      ...
      var a = n.getAttribute('id'),
        ...
        s = ''
      if (
        (o.tildaSendingStatus && (s = o.tildaSendingStatus), !((s && s >= 1) || t_hasClass(o, 't706__submit_disable')))
      )
        if (
...
function t_forms__onRender(t) {
  ...
  !!t.querySelector('.t396') &&
    (t_removeEventListener(t, 'render', t_forms__renderEvent), t_addEventListener(t, 'render', t_forms__renderEvent))
}
...
;((window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2)),
  ...
  t_onReady(function () {
    ...
    ;(t_forms__initForms(),
      ...
      Array.from(document.querySelectorAll('.t396__elem[data-elem-type="form"]:not(.zero-form-rendered)')).forEach(
        function (t) {
  ...
  (window.tildaForm.validate = function (t) {
    for (
      ...
      if (!s(c)) {
        ...
        if ((((v.length && !E) || (E && A)) && (n = !1), u && (b || (E && !A)))) w.type.push('req')
        else {
          switch (d) {
            case 'email':
              ;((m =
            ...
            case 'url':
              ;((m =
                ...
                v.length &&
                  ((f = (f = (f = v.split('//')) && f.length > 1 ? f[1] : f[0]).split('/')) && f.length && f[0]
            ...
            case 'phone':
              ...
              ;(L &&
                (-1 !== L.indexOf('*')
                  ? (I += 'a-zёа-я')
                  : (-1 !== L.indexOf('a') && (I += 'a-z'), -1 !== L.indexOf('а') && (I += 'а-яё'))),
                (I += ']+$'),
                (m = new RegExp(I, 'gi')),
                ((h.length && !h.match(m)) ||
  ...
  (window.tildaForm.showErrorInPopup = function (t, e) {
    ...
    for (var _ = 0; _ < e.length; _++)
      if (e[_] && e[_].obj) {
        ...
        ;(p && (a = p.closest(n)),
          a &&
            ((c = a.querySelectorAll('.t-input-error')), t_addClass(a, 'js-error-control-box'), c.length && (i = !0)))
        for (var w = 0; w < e[_].type.length; w++) {
          ...
          ;((u = ''),
            (l = r.querySelector('.js-rule-error-' + v))
              ...
              : h && -1 === d.indexOf(h) && (d = d + '<p class="t-form__errorbox-item">' + h + '</p>'),
            i &&
  ...
  (window.tildaForm.showSuccessPopupNew = function (t, e, r, o) {
    ...
    function d() {
      ...
      return (
        t || (a.insertAdjacentHTML('beforeend', t_forms__drawNewSuccessPopup()), (t = document.getElementById(n))),
        t
      )
    }
    function m() {
                ...
                if ('object' == typeof objData) {
                  ...
                  try {
                    if (
                      ...
                      window.tildaForm.endpoint.substring(window.tildaForm.endpoint.length - 3) != objData.redirectto
                    )
                      return (
                  ...
                  if (objData && objData.error)
                    ...
                    if (window.Tilda && 'function' == typeof window.Tilda.sendEventToStatistics) {
                      window.tildaForm.tildapayment && window.tildaForm.tildapayment.amount
                        ...
                        : priceEl &&
                          ((price = priceEl.value), parseFloat(price) > 0 && (title = 'Order ' + formResult.orderId))
                      try {
              ...
              ;(Array.prototype.forEach.call(allError, function (t) {
                ;(s
                  ...
                  : formAjaxXhr.statusText
                    ? (t.innerHTML =
                        'Error [' + formAjaxXhr.statusText + ']. Please, try again later. [' + formAjaxXhr.status + ']')
