...
function t396__getWindowDimensions(t) {
  ...
  return (
    ...
    {width: window.tn.window_width, height: window.tn.window_height, cssWidth: window.tn.window_width_css}
  )
}
...
function t396__getAutoHeight(t) {
  ...
  if (i && !o && n) {
    ...
    e = r.reduce(function (e, r) {
      ...
      var l = 0
      if (
        ('gallery' === r.getAttribute('data-elem-type') && (l = t396__autoHeight__getAdditionalOffsetForGallery(r)), i)
      ) {
...
function t396_ab__renderView(t) {
  if (t) {
    ...
    'hug' === t.getAttribute('data-artboard-heightmode') &&
      !r &&
      ((t.style.height = n + 'px'), g && (g.style.height = n + 'px'), w && (w.style.height = n + 'px'))
  }
}
  ...
  switch (e) {
    case 'left':
      ...
      ;(!u && d ? 'grid' === h && c && (y *= k) : (y = A + y),
        'center' === p &&
          ((x = t396_elem__getWidth(r)), f && 'window' !== F && ((V *= k), (x *= k)), (y = V / 2 - x / 2 + y)),
        'right' === p && ((x = t396_elem__getWidth(r)), f && 'window' !== F && ((V *= k), (x *= k)), (y = V - x + y)),
        f && 'window' !== F && (y += ((x = t396_elem__getWidth(r)) * k - x) / 2))
      break
    case 'top':
      ...
      if (
        ...
        (z = 'grid' === h ? parseFloat(W) : parseFloat(C)),
        '%' === t396_elem__getFieldValue(r, 'topunits') && (y = z * (y / 100)),
        v)
      ) {
        var M = parseInt(t396_group__getFieldValue(b, 'top'), 10),
          N
        ;('%' === t396_group__getFieldValue(b, 'topunits') && (M = t396_roundFloat((z * M) / 100)), (y -= M))
        break
      }
      ;(f && 'window' !== F && (y *= k), g && 'window' !== F && (S = 'stretch' === l ? 0 : S / k), (y = S + y))
      ...
      if (
        ...
        'center' === w &&
          ((E = H(r)),
          f && 'window' !== F && ('stretch' !== l ? (z *= k) : (z = Z ? (Z > G ? Z : G) : T.clientHeight), (E *= k)),
          u || !d || c || 'window' === F || 'stretch' !== l || ((z = Z ? (Z > G ? Z : G) : T.clientHeight), (z /= k)),
          (y = z / 2 - E / 2 + y)),
        'bottom' === w &&
          ((E = H(r)),
          f && 'window' !== F && ('stretch' !== l ? (z *= k) : (z = Z ? (Z > G ? Z : G) : T.clientHeight), (E *= k)),
...
function t396_ab__getFieldValue(t, e) {
  ...
  if (
    null === (i = a === l ? t.getAttribute('data-artboard-' + e) : t.getAttribute('data-artboard-' + e + '-res-' + a))
  )
    for (var _ = 0; _ < d.length; _++) {
      ...
      if (
        !(s <= a) &&
        null !==
          (i = s === l ? t.getAttribute('data-artboard-' + e) : t.getAttribute('data-artboard-' + e + '-res-' + s))
      )
        break
    }
...
function t396_group__getFieldValue(t, e) {
  ...
  if (
    null === (i = n === a ? t.getAttribute('data-group-' + e + d) : t.getAttribute('data-group-' + e + '-res-' + n + d))
  )
    for (var _ = 0; _ < l.length; _++) {
      ...
      if (
        !(s <= n) &&
        null !==
          (i = s === a ? t.getAttribute('data-group-' + e + d) : t.getAttribute('data-group-' + e + '-res-' + s + d))
      )
        break
    }
  var u = t396__parseGlobalStyleCSSVar(i)
      ...
      i.forEach(function (t) {
        ;(t.atom.style.removeProperty('line-height'),
          window.t396__isSafari &&
            t.zoom &&
            ((t.atom.style.webkitTextSizeAdjust = 'none'), (t.atom.style.fontSize = ''), (t.element.style.zoom = '')))
      })
    }),
    e.read(function () {
      i.forEach(function (t) {
    ...
    ;(i.read(function () {
      ...
      i.read(function () {
        r.forEach(function (t) {
          ...
          t.correctFontSize =
            i || r ? 'calc(' + e + 'px * var(--zoom, 1))' : 'calc(' + e + 'px * var(--zoom, 1) * var(--zoom, 1))'
        })
      }),
      i.write(function () {
        r.forEach(function (t) {
