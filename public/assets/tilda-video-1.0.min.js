...
function t_video_lazyload__addVideo(e) {
  ...
  var v = e.getAttribute('data-videolazy-nocontrols'),
    ...
    w = e.getAttribute('data-videolazy-inline'),
    b = '',
    h = '100%',
    g = e.getAttribute('data-videolazy-height'),
    z = e.getAttribute('data-videolazy-mob-height')
  if (
    (!t && g && -1 === g.indexOf('vh') && (h = g),
    t && z && -1 === z.indexOf('vh') && (h = z),
    ...
    if ((e.setAttribute('data-videolazy-load', 'true'), 'youtube' === i)) {
      ...
      ;-1 !== r.indexOf('vd.tilda.cc')
        ? (A = r)
        : ((b += 'rel=0&fmt=18&html5=1&showinfo=0'),
          (b += m ? '&autoplay=1' : ''),
          (b += y ? '&mute=1' : ''),
          (b += 'yes' === v ? '&controls=0' : ''),
          (A =
      ...
      var E = /(?:https?:\/\/)?(?:www\.)?(?:vimeo\.com\/|player\.vimeo\.com\/video\/|api\.vimeo\.com\/videos\/)?(\d+)/,
        V = r.match(E)
      ;((r = V && V[1] ? V[1] : r),
        (b = d ? '&h=' + d : ''),
        (b += m ? '&autoplay=1' : ''),
      ...
      ;((b += m ? '&autoplay=1' : ''), (b += y ? '&muted=1' : ''), -1 === r.indexOf('?') && (b = b.replace('&', '?')))
      var P = s + u
      e.insertAdjacentHTML(
        'afterbegin',
        '<iframe id="' +
      ...
      var M = /(?:video|video_ext\.php\?oid=|clip=?|)(-?\d+)_(\d+)|oid=(-?\d+)&id=(\d+)(?:.*?hash=([a-f0-9]+))?/,
        T = r.match(M),
        F = '',
        L = ''
