;((window.Tilda = window.Tilda || {}),
  (function () {
    ...
    ;((Tilda.sendEcommerceEvent = function (e, t) {
      ...
      var p
      ;(('add' !== e && 'remove' !== e) ||
        ((r = '/tilda/cart/' + e + '/'), n > 0 && (r += '' + n), m > 0 ? (r += '-u' + m) : l > 0 && (r += '-' + l)),
        'detail' === e &&
      ...
      (Tilda.sendEventToStatistics = function (e, t, r, a) {
        ...
        if (
          ...
          if (
            ...
            ((r = {
              ecommerce: {
                purchase: {
                  actionField: {id: window.tildaForm.orderIdForStat, revenue: window.tildaForm.amountForStat},
        ...
        if (window.mainMetrikaId && window.mainMetrikaId > 0 && 'function' == typeof ym)
          if (i) {
            var h = {title: t}
            a > 0
              ? ((h.params = {order_price: a}), u && (h.params.currency = u), ym(window.mainMetrikaId, 'hit', e, h))
              : ym(window.mainMetrikaId, 'hit', e, h)
          } else
            a > 0
              ? ((h = {order_price: a}), u && (h.currency = u), ym(window.mainMetrikaId, 'reachGoal', e, h))
            ...
            if (i)
              if (-1 === e.indexOf('tilda/') || (-1 === e.indexOf('/payment/') && -1 === e.indexOf('/submitted/')))
                if (r && r.event && a > 0)
                  ...
                  (e.indexOf('tilda/popup'), window.fbq('track', 'ViewContent', {content_name: t, content_category: e}))
              else
                a > 0 && u
        ...
        if (void 0 !== window.VK && void 0 !== window.VK.Retargeting && !1 === l)
          try {
            if (i) {
              var c,
                _ = (c = document.getElementById('allrecords')) ? c.getAttribute('data-vk-price-list-id') : null,
                b = (_ && parseInt(_)) || 0,
                T = '',
                A = !1,
                F,
              ...
              if (r && r.event)
                if (
                  ...
                  if (a > 0 && b > 0) {
                    ...
                    for (var y = r.ecommerce.purchase.products.length, k = [], g = 0; g < y; g++)
                      ((f = r.ecommerce.purchase.products[g]),
                        A.products.push({id: f.id || f.uid || f.name, price: f.price ? f.price : 0}),
                        (A.total_price = a))
                    T = 'init_checkout'
                  } else T = 't-purchase'
                else if ('addToCart' === r.event && r.ecommerce.add)
                ...
                T =
                  't-purchase-' +
                  (F = (F = (F = e.replace('/tilda/', '')).replace('tilda/', '')).replace('/payment/', ''))
              else if (-1 !== e.indexOf('tilda/') && -1 !== e.indexOf('/submitted/'))
                T =
                  't-lead-' +
                  (F = (F = (F = e.replace('/tilda/', '')).replace('tilda/', '')).replace('/submitted/', ''))
        ...
        if (window.mainMailruId > '0') {
          ...
          i
            ? a > 0
              ? E.push({id: '' + window.mainMailruId, type: 'pageView', url: e, value: a, start: new Date().getTime()})
              : E.push({id: '' + window.mainMailruId, type: 'pageView', url: e, start: new Date().getTime()})
            : a > 0
        ...
        'function' == typeof window.tildastat &&
          (i
            ? (e.indexOf('payment') > 0 && e.indexOf('tilda/form') > -1 && (e = e.replace('tilda/form', 'tilda/rec')),
