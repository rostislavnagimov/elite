    ...
    setTimeout(function () {
      'object' == typeof performance &&
        ...
        (window.t_lazyload_domloaded =
          1 * window.performance.timing.domContentLoadedEventEnd - 1 * window.performance.timing.navigationStart)
    }, 0))
}
      ...
      if ('y' !== window['lazy_ok_' + e]) {
        ...
        ;(Array.prototype.forEach.call(i, function (e) {
          ...
          ;((i = e.lazy_loading_src),
            'string' == typeof str && 0 === i.indexOf(t) && (e.classList.remove('loading'), (e.wasProcessed = !1)))
        }),
          t_lazyload_update())
      }
    }, 1e4))
  ...
  (function (e, t) {
    ...
    function s() {
      i ||
        ...
        (l = {com: 'com', info: 'pub', pub: 'pub', ink: 'ink', pro: 'pro', biz: 'biz', net: 'net', one: 'one'}))
    }
    function c() {
      var e
        ...
        if (
          ...
          if (d) {
            var M = t_lazyload__getBackgroundStyles(t),
              ...
              j = M.attachment,
              B = 'IMG' === t.tagName
            ;((I = t_lazyload__getResizeCommand(B, C)), (b = R), (v = T), 'fixed' === j && B && (N = !0))
          } else N = !0
        else I = 'resize'
      ...
      if ('resize' == t)
        ...
        ;('left' !== a && 'right' !== a && (x = 'center'),
          ...
          (_ = i.split('/')).splice(
            i.split('/').length - 1,
            0,
            '-/' + t + '/' + s + 'x' + c + '/' + x + '/' + f + '/' + ('y' == window.lazy_webp ? '-/format/webp' : '')
          ),
          (u = b(_.join('/'))))
      }
      var m = '.webp',
    ...
    function I(e, t, i) {
      if ('string' == typeof t && null != t && '' != t) {
        ...
        if ((console.error('lazy loading err'), h(t)))
          return ((window.lazy_err_static = 'y'), void L(e, t.replace(r, '/static3.tildacdn.com/')))
          ...
          if (o.length > 3)
            for (var s = 0; s < o.length; s++)
              '' !== o[s] &&
                ...
                s == o.length - 1 && (l = o[s]))
          if ('' !== a && '' !== l)
            L(e, 'https://static3.tildacdn.com/' + a + '/' + (l = l.replace(/(\.(jpe?g|png|gif|svg))\.webp$/i, '$1')))
          if ('function' != typeof t_errors__sendCDNErrors) {
            var u = document.createElement('script')
            ;((u.src = 'https://static.tildacdn.' + t_lazyload__getRootZone() + '/js/tilda-errors-1.0.min.js'),
        ...
        ;(!e.getAttribute('src') && i.placeholder && e.setAttribute('src', i.placeholder),
          ...
          t.addEventListener('error', function (t) {
            ;(m(e, i.class_loading),
              ...
              void 0 !== t.path ? I(e, t.path[0].currentSrc, n) : void 0 !== t.target && I(e, t.target.currentSrc, n))
          }),
          f(e, i.class_loading),
          (n = c()),
        ...
        ;(('IMG' !== e.tagName && 'IFRAME' !== e.tagName) ||
          ...
          e.addEventListener('error', function (o) {
            ;(e.removeEventListener('load', n),
              ...
              void 0 !== o.path ? I(e, o.path[0].currentSrc, i) : void 0 !== o.target && I(e, o.target.currentSrc, i))
          }),
          f(e, t.class_loading)),
          (i = c()),
              ...
              if (!(e._settings.skip_invisible && x(n) && n.isNotUnderScreenRange)) {
                ...
                if (n.wasProcessed)
                  return (
                    ...
                    void (e._settings.callback_processed && e._settings.callback_processed(e._elements.length))
                  )
