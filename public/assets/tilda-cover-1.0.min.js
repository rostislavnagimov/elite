...
function t_cover__setCoverVideoParams(e, t, o, r) {
  ...
  if (
    ...
    (t['video-url-vimeo'] || t['video-url-rutube'] || t['video-url-kinescope'] || t['video-url-vkvideo']) &&
      (n = 'iframe'),
    ((!window.t_cover__isMobile && !('ontouchend' in document)) ||
  ...
  window.addEventListener('scroll', function () {
    if (o && a) {
      var t = e.parentElement,
        ...
        _
      i >= d + c
        ? ((e.style.position = 'absolute'), (e.style.bottom = '0px'), (e.style.top = 'auto'))
        : r >= d
  ...
  if (t) {
    ...
    o &&
      o.addEventListener('click', function () {
        var e, o
        t.offsetHeight &&
          t_cover__scrollToNextSection(t.offsetHeight + t.getBoundingClientRect().top + window.pageYOffset)
      })
  }
}
function t_cover__initCovers() {
  ...
  ;(e && 'edit' === e.getAttribute('data-tilda-mode')) ||
    Array.from(document.querySelectorAll('.t-cover__carrier')).forEach(function (e) {
...
function t_cover__recalcCoverHeight(e, t) {
  ...
  if (o) {
    var r = o.querySelector('.t-cover'),
      n = o.getAttribute('data-parenttplid') || o.getAttribute('data-record-type')
    if (r && '935' !== n) {
      ...
      v &&
        _.forEach(function (e) {
          ...
          ;(u && '.t-cover__carrier' === e) ||
            Array.prototype.slice.call(o.querySelectorAll(e)).forEach(function (e) {
      ...
      ;(p > m && g < p + h) || d || ((window.t_cover__isMobile || 'ontouchend' in document) && t)
        ...
        : window.t_cover__isMobile && y
          ...
          : g > p + h && (t_cover__setRecalculatedHeight(o, p), t_cover__updateResizeElem(o))
    }
  }
}
  ...
  ;((d || e.querySelector('.t734')) && g.push('.t-slds__items-wrapper'),
    g.forEach(function (t) {
      ...
      Array.prototype.slice.call(e.querySelectorAll(t)).forEach(function (e) {
        c && e && e.classList.contains('t-cover__carrier') && l < document.documentElement.clientHeight
          ? ((s = 0.2 * document.documentElement.clientHeight), (e.style.height = l + s + 'px'))
  ...
  return (
    (e &&
      (e.getAttribute('data-parenttplid') ||
        ...
        (null == (t = e.closest('.record')) ? void 0 : t.getAttribute('data-parenttplid')) ||
        (null == (o = e.closest('.record')) ? void 0 : o.getAttribute('data-record-type')))) ||
    ''
  )
}
...
function t_cover__fixBgFixedNode(e) {
  ...
  if (t && o) {
    var r = o.getAttribute('data-parenttplid') || o.getAttribute('data-record-type'),
  ...
  var r = window.pageYOffset,
    ...
    c = setInterval(function () {
      ;((i += n),
        ...
        ((e - r < 0 && window.pageYOffset <= e) || (e - r > 0 && window.pageYOffset >= e)) &&
...
;((window.t_cover__isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
  navigator.userAgent
)),
  t_onReady(function () {
