...
var t396__uniqueId__generator = function t() {
  ...
  t_zeroForms__waitForResources = function t(e) {
    try {
      return Promise.resolve(Promise.allSettled(window.t_zeroForms__resourcesQueue[e] || [])).then(function () {})
    } catch (r) {
...
if (
  ((window.t_zeroForms__browserLang = (window.navigator.userLanguage || window.navigator.language)
    .toUpperCase()
    .slice(0, 2)),
  (window.t_zeroForms__isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
    navigator.userAgent
  )),
...
function t_zeroForms__renderForm(t, e, r, o) {
  ...
  if (
    ...
    (!t_zeroForms__isRecordHidden(t.closest('.r')) && !t_zeroForms__isFormOutside(t)) || 'published' !== o)
  ) {
    if (!e) {
    ...
    if (d) {
      ;(_.insertAdjacentElement('beforeend', d), t_zeroForms__placeFormIntoColumns(t))
...
function t_zeroForm__prepareFormIds__editor() {
  ...
  o.length &&
    r &&
    (window.t_zeroForms__formIdMap = (((e = {})[r] = t_zeroForms__prepareFormIds__buildFormsIdsMap(r, o)), e))
}
...
function t_zeroForms__createForm(t, e, r, o) {
  ...
  if (
    ...
    t_zeroForms__addResource({recId: t, id: z, path: 'tilda-zero-form-horizontal.min.css', type: 'link'})
  ...
  ;(t_zeroForms__addInlineTag({
    ...
    'y' === n.inputsstyle2 &&
      t_zeroForms__onRender(o, !1, function () {
        ;('zero' === window.tildamode && (n = t_zeroForms__createFormObj(t, o)), t_zeroForms__animateInputs(o, n, t, l))
      }))
  ...
  if (n.fieldfontfamily) {
    ...
    ;((x = x.reduce(function (t, e, r) {
      return ((t += w + '.t-input-block ' + e), r !== x.length - 1 && (t += ', '), t)
    }, '')),
      t_zeroForms__addInlineTag({
        tag: 'style',
        id: h,
  ...
  if (
    ...
    var L = document.querySelectorAll('[data-record-type="803"], [data-parenttplid="803"]')
...
function t_zeroForms__updateStylesOnResize(t, e) {
  ...
  var d = {
    ...
    c = 'variation' === r.inputtitlefontweight ? r.inputtitlevariationweight : r.inputtitlefontweight,
...
function t_zeroForms__parseIntoElement(t, e, r, o, n, i) {
  ...
  ;(l && s.setAttribute('data-default-value', l), t_zeroForms__setStylesForFormGroup(o, s))
  var _ = 'variation' === o.inputfontweight ? o.inputvariationweight : o.inputfontweight,
    d = 'variation' === o.inputelsfontweight ? o.inputelsvariationweight : o.inputelsfontweight,
  ...
  switch ((f.classList.add('t-input-block'), r.li_type)) {
    ...
    case 'sb':
      ...
      if (((b = t_zeroForms__createSelect(r, u, p, g)), (o.inputsstyle && o.inputelscolor) || u.color)) {
        var v = document.createElement('style'),
          F = t_zeroForms__createSelector(t, i, '.t-select__wrapper:after'),
          z = o.inputsstyle ? o.inputelscolor : u.color
        ;((v.textContent = F + '{border-top-color:' + z + ';}'), b.insertAdjacentElement('beforeend', v))
      }
      break
    case 'rd':
    ...
    case 'fr':
      if (((b = t_zeroForms__createCalculation(t, r, u, p, n)), o.inputfrbgcolor)) {
        ...
        ;((k.textContent = S + '{background-color:' + o.inputfrbgcolor + '; padding: 20px 30px 25px;}'),
...
function t_zeroForms__createInput(t, e, r, o) {
  ...
  'oneline' === o &&
    (r.rule && n.setAttribute('data-tilda-rule', r.rule), r.mask && n.setAttribute('data-tilda-mask', r.mask)),
...
function t_zeroForms__setTextareaHeight(t, e) {
  var r = 25,
    o = 10
  ;(t.li_rows > 1 && ((e.style.height = t.li_rows * r + o + 'px'), e.setAttribute('data-rows', t.li_rows)),
...
function t_zeroForms__createRadio(t, e, r, o, n, i, a) {
  ...
  ;(_ && c.appendChild(t_zeroForms__createNameFieldForCheckbox(r, m, 'checkboxes')), c.appendChild(m))
  ...
  if (n) {
    ...
    return (
      i.forEach(function (n, i) {
        ...
        var f = t_zeroForms__createIndicator('img-select', !1, {ratio: c, img: n.img})
        if (
...
function t_zeroForms__createCheckbox(t, e, r, o) {
  ...
  var l = t396_zeroForms__prepareCalcValue(t, t.li_label),
    _ = l.label,
    d = l.calcValue
  return (d && t396_zeroForms__setCalcValue(i, d), (s.innerHTML = _), n.insertAdjacentElement('beforeend', s), n)
}
function t_zeroForms__createUploadField(t, e, r, o) {
  var n = 'uw' === o
  if ('published' !== window.tildamode) {
    var i = 'color:#fff;background-color:#000; padding:10px 20px; display:inline-block;',
      a = document.createElement('div')
    a.setAttribute('style', i)
    var s = n && '' === e.li_uwkey
    return ((a.textContent = s ? 'Please set the key' : 'Upload button will be here'), a)
  }
  ...
  ;(t_zeroForms__appendMainSettingToField(c, r, 'hidden', ''),
    ...
    n
      ? (c.setAttribute('data-tilda-upwidget-key', e.li_uwkey || ''),
        'y' === e.li_multiupl && c.setAttribute('data-tilda-upwidget-multiple', '1'))
  ...
  return (
    'uploadcare-3.x.min.js' !== u || window.jQuery || (u = 'uploadcare-3.x.full.min.js'),
    (n || (!n && !document.querySelector('script[src*="uploadcare-3.x"]'))) &&
      t_zeroForms__addResource({recId: t, id: l + '-zero-form', path: u, type: 'script'}),
    _
  )
}
function t_zeroForms__createDateField(t, e, r, o, n) {
  ...
  ;(s.length && ',' === s[s.length - 1] && (s = s.slice(0, -1)),
    t_zeroForms__appendMainSettingToField(a, r, 'text', ['t-input', 't-datepicker', 'js-tilda-mask']),
  ...
  return (
    ...
    t_zeroForms__addResource({recId: t, id: 't-zero-date-styles', path: 'tilda-date-picker-1.0.min.css', type: 'link'}),
    t_zeroForms__addResource({
      recId: t,
...
function t_zeroForms__createQuantityRange(t, e, r, o, n) {
  ...
  ;(t_zeroForms__appendMainSettingToField(a, n, 'range', 't-range'),
    ...
    (a.style.width = '100%'),
    e.li_title || e.li_subtitle ? (a.id = e.li_type + '-' + e.lid) : (a.ariaLabel = 'range'),
    i.insertAdjacentElement('beforeend', a))
  var s = document.createElement('div')
  ...
  var _ = t_zeroForms__createRangeField('min', o.inputtitlecolor, e.li_vmin || '0'),
    d = t_zeroForms__createRangeField('max', o.inputtitlecolor, e.li_vmax || '10')
  return (
    l.insertAdjacentElement('beforeend', _),
    l.insertAdjacentElement('beforeend', d),
    i.insertAdjacentElement('beforeend', l),
    t_zeroForms__addResource({recId: t, id: 't-zero-range-script', path: 'tilda-range-1.0.min.js', type: 'script'}),
    t_zeroForms__addResource({recId: t, id: 't-zero-range-styles', path: 'tilda-range-1.0.min.css', type: 'link'}),
    i
  )
}
...
function t_zeroForms__createCalculation(t, e, r, o, n) {
  ...
  if (
    ...
    t_zeroForms__addResource({recId: t, id: 't-zero-calc', path: 'tilda-calc-1.0.min.js', type: 'script'}),
    i.appendChild(s),
    'y' !== e.li_addtocart)
  )
    return i
  if (e.li_prod_title) {
    var _ = t_zeroForms__createHiddenField(e.li_prod_title, 'prod_title', 't-calc__hidden__prod_title')
    s.insertAdjacentElement('beforeend', _)
  }
  if (e.li_prod_img) {
    var d = t_zeroForms__createHiddenField(e.li_prod_img, 'prod_img', 't-calc__hidden__prod_img')
    s.insertAdjacentElement('beforeend', d)
  }
  if (e.li_prod_options) {
    var c = t_zeroForms__createHiddenField(e.li_prod_options, 'prod_options', 't-calc__hidden__prod_options')
    s.insertAdjacentElement('beforeend', c)
  }
  return i
}
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
  ...
  ;(l && ((c += ', '), (c += d + '.uploadcare--widget__button.uploadcare--widget__button_type_open')),
  ...
  u &&
    ...
    l &&
      ((p += d + '.uploadcare--widget__button.uploadcare--widget__button_type_open '),
      (p += '{background-image: ' + o.buttonbgcolor + '; background-color: transparent;}')),
    _ &&
  ...
  if (
    ...
    ;(z && z.parentElement && z.parentElement.removeChild(z),
      t_zeroForms__addInlineTag({tag: 'style', id: F, content: v, zeroForm: n}))
  }
}
...
function t_zeroForms__getBottomText(t, e, r, o, n) {
  ...
  if (
    ...
    var l = document.createElement('input'),
      _
    ;(t_zeroForms__appendMainSettingToField(l, {name: 'form_bottom_checkbox'}, 'checkbox', 't-checkbox'),
    ...
    ;(c.classList.add('t-checkbox__labeltext'), (c.innerHTML = n), s.insertAdjacentElement('beforeend', c))
...
function t_zeroForms__animateInputs(t, e, r, o) {
  ...
  var s = (Number(e.inputheight) - Number(e.inputfontsize)) / 2,
    ...
    d
  if (
    (Array.prototype.slice.call(document.querySelectorAll(_)).forEach(function (t) {
      ...
      if (r) {
        ...
        ;(o.classList.add('t-input__vis-ph'),
          ...
          e.inputfontsize &&
            ((o.style.fontSize = e.inputfontsize + 'px'), (o.style.height = parseInt(e.inputfontsize, 10) + 1 + 'px')),
          (o.textContent = r),
...
function t_zeroForms__appendStylesToField(t, e) {
  for (var r in (t.classList.contains('t-input-inline-styles') || t.classList.add('t-input-inline-styles'), e))
    t.style[r] = e[r]
...
function t_zeroForms__createInputPlaceholderStyles(t, e, r, o) {
  ...
  ;(i.forEach(function (t) {
    ...
    t_zeroForms__addInlineTag({tag: 'style', id: 't-zero-placeholder-' + r + '-' + t, content: s, zeroForm: o}))
}
...
function t_zeroForms__createSelector(t, e, r) {
  var o
  return (
    ('zero' === window.tildamode ? '[data-record-id="' + t + '"]' : '#rec' + t) + ' [data-elem-id="' + e + '"] ' + r
  )
}
  ...
  if ('function' == typeof window[t]) e()
    ...
    setTimeout(function o() {
      ...
      'function' != typeof window[t]
        ? ('complete' === document.readyState && i - r > 7e3 && 'function' != typeof window[t] && n(),
          setTimeout(o, 100))
        : e()
    })
  }
