...
export const metadata: Metadata = {
  title: 'Вакансии - Логистика и транспорт | Elite',
  description: 'Вакансии в сфере логистики и транспорта в Алматы. Логисты, менеджеры по перевозкам, специалисты по складу.',
  alternates: {
    canonical: 'https://elite.kz/logistika-transport'
  }
}
...
const schema = {
  ...
  '@type': 'CollectionPage',
  name: 'Вакансии - Логистика и транспорт',
  url: 'https://elite.kz/logistika-transport'
}

export default function LogistikaPage() {
  const categorySlug = 'logistika-transport'
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen flex-col items-center bg-white p-4 pt-[120px] md:p-8 md:pt-[140px]">
        <div className="w-full max-w-[1200px]">
          ...
          <VacancyList vacancies={categoryVacancies} categoryName="Логистика, транспорт" />
        </div>
      </div>
    </main>
  )
