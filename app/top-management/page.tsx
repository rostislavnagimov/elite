...
export const metadata: Metadata = {
  title: 'Вакансии - Топ-менеджмент | Elite',
  description: 'Вакансии для топ-менеджеров в Алматы. Директора, руководители, С-level позиции.',
  alternates: {
    canonical: 'https://elite.kz/top-management'
  }
}
...
const schema = {
  ...
  '@type': 'CollectionPage',
  name: 'Вакансии - Топ-менеджмент',
  url: 'https://elite.kz/top-management'
}

export default function TopManagementPage() {
  const categorySlug = 'top-management'
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen flex-col items-center bg-white p-4 pt-[120px] md:p-8 md:pt-[140px]">
        <div className="w-full max-w-[1200px]">
          ...
          <VacancyList vacancies={categoryVacancies} categoryName="Топ-менеджмент" />
        </div>
      </div>
    </main>
  )
