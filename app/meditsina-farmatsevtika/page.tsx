...
export const metadata: Metadata = {
  title: 'Вакансии - Медицина и фармацевтика | Elite',
  description: 'Вакансии в сфере медицины и фармацевтики в Алматы. Медицинские представители, фармацевты, врачи.',
  alternates: {
    canonical: 'https://elite.kz/meditsina-farmatsevtika'
  }
}
...
const schema = {
  ...
  '@type': 'CollectionPage',
  name: 'Вакансии - Медицина и фармацевтика',
  url: 'https://elite.kz/meditsina-farmatsevtika'
}

export default function MeditsinaPage() {
  const categorySlug = 'meditsina-farmatsevtika'
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen flex-col items-center bg-white p-4 pt-[120px] md:p-8 md:pt-[140px]">
        <div className="w-full max-w-[1200px]">
          ...
          <VacancyList vacancies={categoryVacancies} categoryName="Медицина, фармацевтика" />
        </div>
      </div>
    </main>
  )
