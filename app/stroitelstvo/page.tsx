...
export const metadata: Metadata = {
  title: 'Вакансии - Строительство | Elite',
  description: 'Вакансии в сфере строительства и недвижимости в Алматы. Прорабы, инженеры, архитекторы, строители.',
  alternates: {
    canonical: 'https://elite.kz/stroitelstvo'
  }
}
...
const schema = {
  ...
  '@type': 'CollectionPage',
  name: 'Вакансии - Строительство',
  url: 'https://elite.kz/stroitelstvo'
}

export default function StroitelstvoPage() {
  const categorySlug = 'stroitelstvo'
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen flex-col items-center bg-white p-4 pt-[120px] md:p-8 md:pt-[140px]">
        <div className="w-full max-w-[1200px]">
          ...
          <VacancyList vacancies={categoryVacancies} categoryName="Строительство" />
        </div>
      </div>
    </main>
  )
