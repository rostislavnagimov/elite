...
export const metadata: Metadata = {
  title: 'Вакансии - Юриспруденция | Elite',
  description: 'Вакансии в сфере юриспруденции в Алматы. Юристы, юрисконсульты, специалисты по договорной работе.',
  alternates: {
    canonical: 'https://elite.kz/yurisprudentsiya'
  }
}
...
const schema = {
  ...
  '@type': 'CollectionPage',
  name: 'Вакансии - Юриспруденция',
  url: 'https://elite.kz/yurisprudentsiya'
}

export default function YurisprudentsiyaPage() {
  const categorySlug = 'yurisprudentsiya'
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen flex-col items-center bg-white p-4 pt-[120px] md:p-8 md:pt-[140px]">
        <div className="w-full max-w-[1200px]">
          ...
          <VacancyList vacancies={categoryVacancies} categoryName="Юриспруденция" />
        </div>
      </div>
    </main>
  )
