...
export const metadata: Metadata = {
  title: 'Вакансии - Образование | Elite',
  description: 'Вакансии в сфере образования в Алматы. Преподаватели, методисты, менеджеры образовательных проектов.',
  alternates: {
    canonical: 'https://elite.kz/obrazovaniye'
  }
}
...
const schema = {
  ...
  '@type': 'CollectionPage',
  name: 'Вакансии - Образование',
  url: 'https://elite.kz/obrazovaniye'
}

export default function ObrazovaniyePage() {
  const categorySlug = 'obrazovaniye'
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen flex-col items-center bg-white p-4 pt-[120px] md:p-8 md:pt-[140px]">
        <div className="w-full max-w-[1200px]">
          ...
          <VacancyList vacancies={categoryVacancies} categoryName="Образование" />
        </div>
      </div>
    </main>
  )
